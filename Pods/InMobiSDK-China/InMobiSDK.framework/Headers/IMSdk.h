 ...
 */
+(void)initWithAccountID:(NSString *)accountID consentDictionary:(NSDictionary*)consentDictionary __attribute__((deprecated("Please use API initWithAccountID: as this API can be removed in future")));
 ...
 */
+(void)updateGDPRConsent:(NSDictionary *)consentDictionary __attribute__((deprecated("This API is deprecated and API can be removed in future")));
