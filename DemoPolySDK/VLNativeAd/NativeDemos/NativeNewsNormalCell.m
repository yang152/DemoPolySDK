...
@implementation NativeNewsNormalCell
...
-(void)refreshUIWithModel:(NativeNewsNormalModel *)model {
    self.model = model;
    _titleLabel.attributedText = [NativeHelper titleAttributeText:model.title];
    _sourceLable.attributedText = [NativeHelper subtitleAttributeText:model.source];
